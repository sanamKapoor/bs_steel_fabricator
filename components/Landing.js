...
function Landing() {
    return (
        ...
        <section className="w-5/6 md:w-5/6 xl:w-4/5 mx-auto grid grid-cols-1 md:grid-cols-2 overflow-hidden">
            <div className="place-self-center mt-4 sm:mt-6 md:my-0 text-center md:text-left">
                <h1 className="xl:text-5xl md:text-4xl sm:text-2xl text-xl font-bold">Welcome to B.S Steel Fabricator and Doors</h1>
            ...
            <div className="place-self-center">
                <img src="/img/home-door.jpg" className="relative top-7 sm:top-8 md:top-10 md:left-10" alt="" />
            </div>
        </section>
    </main>
    )
